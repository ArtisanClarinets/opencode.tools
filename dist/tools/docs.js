...
async function generatePRD(researchDossier, discoverySession) {
    ...
    await (0, audit_1.logToolCall)(RUN_ID, 'docs.prd.generate', { research_id: 'res-1', disc_id: 'sess-1' }, { prd_length: prd.length });
    return { prd };
}
/**
...
async function generateSOW(proposalData) {
    ...
    await (0, audit_1.logToolCall)(RUN_ID, 'docs.sow.generate', { proposal_id: 'prop-1' }, { sow_length: sow.length });
    return { sow };
}
